...
func TestOperatorPermutations(t *testing.T) {
	permutations := day07.OperatorPermutations(2)

	expectedPermutations := [][]day07.Operator{
		{day07.Add, day07.Add},
		{day07.Add, day07.Subtract},
		{day07.Add, day07.Divide},
		{day07.Add, day07.Multiply},
		{day07.Subtract, day07.Add},
		{day07.Subtract, day07.Subtract},
		{day07.Subtract, day07.Divide},
		{day07.Subtract, day07.Multiply},
		{day07.Divide, day07.Add},
		{day07.Divide, day07.Subtract},
		{day07.Divide, day07.Divide},
		{day07.Divide, day07.Multiply},
		{day07.Multiply, day07.Add},
		{day07.Multiply, day07.Subtract},
		{day07.Multiply, day07.Divide},
...
func TestEquation_IsSolvable(t *testing.T) {
	...
	isSolvable := equation.IsSolvable()
